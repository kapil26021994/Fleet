...
@NgModule({
  declarations: [UserReportComponent, StoppageReportComponent, RawDetailComponent, SpeedReportComponent, VehiclePerformanceComponent, VehicleLogComponent, TripSummaryComponent, TripSummaryTimeComponent, EventLogComponent],
  imports: [
    CommonModule,
    SharedModule,
