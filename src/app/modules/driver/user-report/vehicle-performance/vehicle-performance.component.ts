...
filteredValues =  {driver: '',driverMobile:'',maxSpeed: '',movement: '',period:'',vname:''};
reportTypeList = [];
public displayedColumns :any[] =  ['driver','driverMobile','maxSpeed','movement','period','vname'];
    ...
    updateDataViaKey(value,key):void{
      ...
      getReportData(form){
        if(form){
          ...
          this.userService.storeDataToDb(this.reportAdd,'VehiclePerformanceReport').subscribe((data:any)=>{
            if(data.length>0){
      ...
      formSubscribe() {
        this.companyName.valueChanges.subscribe((positionValue) => {
          ...
          this.filteredValues['driverMobile'] = positionValue;
          this.filteredValues['maxSpeed'] = positionValue;
      ...
      getFormsValue() {
        this.dataSource.filterPredicate = (data, filter: string): boolean => {
          ...
          const resultValue =
            ...
            data.driverMobile.toString().trim().toLowerCase().indexOf(searchString.driverMobile != null ? searchString.driverMobile.toLowerCase() : '') !== -1 || 
            data.maxSpeed.toString().trim().toLowerCase().indexOf(searchString.maxSpeed != null ? searchString.maxSpeed.toLowerCase() : '') !== -1 ||
            ...
            data.vname.toString().trim().toLowerCase().indexOf(searchString.vname != null ? searchString.vname.toLowerCase() : '') !== -1
          return resultValue;
        };
        this.dataSource.filter = JSON.stringify(this.filteredValues);
      }
